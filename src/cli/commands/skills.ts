...
const SKILL_DEFINITIONS: SkillDefinition[] = [
  {
    ...
    description:
      `FIRST choice for CONCEPT and BEHAVIOR questions like "how is quiz scoring calculated" or "what happens on subscription cancel". Do NOT use for keyword/identifier lookups — use grep instead. If the search term is also a code identifier (entity name, class name, variable name), this is the WRONG tool.`,

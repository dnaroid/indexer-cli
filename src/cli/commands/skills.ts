...
const SKILL_DEFINITIONS: SkillDefinition[] = [
  {
    ...
    description:
      `description: PREFER over grep for conceptual questions like "how does X work", "how is X calculated", or any question about behavior/flow. Use when the user asks about a concept, behavior, or flow — not a specific symbol or literal string.`,
